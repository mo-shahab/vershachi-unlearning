...
# Importing from federated_unlearning package
from vershachi.federated_unlearning.model_initialization import model_init
from vershachi.federated_unlearning.data_preprocess import data_init
from vershachi.federated_unlearning.fed_learn_base import global_train_once
from vershachi.federated_unlearning.fed_learn_base import fedavg
from vershachi.federated_unlearning.fed_learn_base import test
from vershachi.federated_unlearning.fed_learn_base import FL_Train, FL_Retrain
from vershachi.federated_unlearning.fed_unlearn_base import (
    unlearning,
    unlearning_without_cali,
    federated_learning_unlearning,
)
from vershachi.federated_unlearning.membership_inference import (
    train_attack_model,
    attack,
)

# initialize the dataset directory in here
DATASETS_DIR = r"C:\dev\vershachi-unlearning\datasets"
...
def Federated_Unlearning():
    ...
    #
    old_GMs, unlearn_GMs, uncali_unlearn_GMs = federated_learning_unlearning(
