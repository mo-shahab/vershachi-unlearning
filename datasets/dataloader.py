...
train_data = np.load(r'C:\dev\vershachi-unlearning\examples\purchase2_train.npy', allow_pickle=True)
test_data = np.load(r'C:\dev\vershachi-unlearning\examples\purchase2_test.npy', allow_pickle=True)
