...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--nhidden",
        help="MAF's hidden layers: [nhidden, nhidden]",
        required=False,
        type=int,
        default=30,
    )
    ...
    parser.add_argument(
        "--nsample",
        help="num of samples to optimize E(L/U)BO",
        required=False,
        type=int,
        default=1000,
    )
    ...
    parser.add_argument(
        "--batchsize",
        help="batch size of data per training iteration",
        required=False,
        type=int,
        default=1000,
    )
    ...
    parser.add_argument(
        "--folder",
        help="folder to write output: folder/expr/",
        required=False,
        type=str,
        default="out",
    )
    ...
    parser.add_argument(
        "--gpu", help="index of GPU to run", required=False, type=str, default="0"
    )
